...
export default function LabUpload() {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Register the uploaded file on blockchain
      const blockchainRes = await fetch('/api/genomic-records', {
        method: 'POST',
        ...
        body: JSON.stringify({
          ...
          blockchainTxHash: '', // Will be generated by the API
          tags: [],
        }),
      })
      ...
      setUploadResult({
        recordId: blockchainData.data?.recordId || 'GR-NEW',
        fileType: data.data.fileType,
        pid: data.data.pid,
        ipfsCID: data.data.ipfsCID,
        fileHash: data.data.fileHash,
        blockchainTxHash: blockchainData.data?.blockchainTxHash || 'pending',
